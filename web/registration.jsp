        ...
        <div class="jumbotron">
            <div class="container">
                ...
                <div class="col-md-offset-4">
                    ...
                    <form name="registrationForm" method="post" action="registration.jsp" onsubmit="return confirmPassword();">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" id="conf_password" class="form-control" placeholder="Password" required="required" />
                        </div>
                        <br/>
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="creditcard" placeholder="Carta di Credito" required="required" />
                        </div>
                        <br/>
                    ...
                    <%} else {%>
                    <span class="label label-success"><a href="home.jsp">Registrazione Completata</a></span>
                    <%}%>
                </div>
            </div>
        </div>
